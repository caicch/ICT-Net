...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default="./current_best/", help='model checkpoint.')
    ...
    for i in range(len(filename)):
        ...
        checkpoint_path = os.path.join(args.path, filename[i]) #os.path.join(args.path, "BEST_checkpoint_resnet101_MCCFormers_diff_as_Q_trans.pth.tar") #os.path.join(args.path, filename[i])
