...
#             break
        ...
        feat_out = encoder_feat(imgs_A,imgs_B) # fused_feat: (S, batch, feature_dim)
...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--encoder_image', default="resnet101", help='which model does encoder use?')#vit_b_16
